<section class="hero" id="home">
        <div class="hero-text">
            <h2>Datang Lelah & Letih <h/2>
        <h2>Pulang Sehat & <span class="highlight">Bugar</span></h2>
            ...
            <div class="hero-stats">
                ...
                <div class="stat-item">
                    ...
                    <span class="stat-label">Cabang di Aceh</span>
                </div>
                <div class="stat-item">
                    <span class="stat-number">24</span>
                    <span class="stat-label">Jam Layanan di peunayong </span>
                </div>
            </div>
    ...
    <div class="hero-image-container"> 
        <img src="assets/uploads/kaki.jpg" alt="Layanan Bugar Refleksi">
    </div>
</div>
    </div>
</section>